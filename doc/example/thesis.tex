...
\end{comment}
	...
	Therefore, Theorem \ref{thm: Kolmogrov and Yaglom theorem}(1) is usually called Kolmogorov's theorem, and Theorem \ref{thm: Kolmogrov and Yaglom theorem}(2) is usually called Yaglom's theorem.
...
\end{thm}
	...
	As mentioned earlier, analogues results of Theorem \ref{thm: Kolmogrov and Yaglom theorem} and Theorem \ref{thm: Slack result} were obtained for a lots of Markovian branching processes. 
